// okay i was able to resolve it was not because of sentry but Pin component as you can't add a div inside a A tag and Link tag is considered an A tag so to fix it change your code i'll share the code here
