                ...
                >
                    ...
                    >
                        <div className='relative flex items-center justify-center overflow-hidden sm:w-[570px] w-[80vw] sm:h-[40vh] h-[30vh] mb-10'>
                            <div className='relative flex items-center justify-center overflow-hidden lg:rounded-3xl bg-[#13162d]'>
                                <img 
                                    src="/bg.png" 
                                    alt="bg-img"
                                />
                        ...
                        <div className='flex items-center justify-between mt-7 mb-3'>
                            ...
                            <div className="flex justify-center items-center">
                                <p className="flex lg:text-xl md:text-xs text-sm text-purple">Check Website</p>
